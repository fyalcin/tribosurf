...
class SlabWF:
    ...
    def conv_slabthick_surfene(
        ...
        name = (
            "Slab Thickness optimization of "
        ...
        ft_start_thick_convo = FT_StartThickConvo(
            structure=structure,
            mp_id=mp_id,
            miller=miller,
            ...
            if cluster_params["print_help"]:
                print(
                    ...
                    "pprint.pprint(results)\n".format(
                        db_file, functional, mp_id, miller
                    )
                )

...
print(
    ...
    "Energy per atom: ",
    energy_properties["energy_per_atom"],
)
...
# Update many
nav.update_many_data(
    "Collection_test",
    {"tag": 0, "chem_formula": "NaCl", "Energy": 1000, "Energy per atom": 10},
    {
        "$set": {
            "tag": 0,
            "chem_formula": "NaCl",
...
nav.insert_data(
    "Collection_test",
    {"tag": 0, "chem_formula": "NaCl", "Energy": 20, "Energy per atom": 10},
)

...
from triboflow.utils.utils import read_runtask_params, write_one_dict
...
class FT_GenerateSlabs(FiretaskBase):
    ...
    def _convert_to_list(self, p):
        GenerateSlabsError.check_inputs(
            p["miller"], p["thickness"], p["vacuum"], p["entry"]
        )

...
class FT_UpdateInterfaceCompParams(FiretaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        encut_1 = bulk_1["comp_parameters"]["encut_info"]["final_encut"]
        encut_2 = bulk_2["comp_parameters"]["encut_info"]["final_encut"]
        encut_inter = max(encut_1, encut_2)
        k_dens_1 = bulk_1["comp_parameters"]["k_dense_info"]["final_k_dens"]
        k_dens_2 = bulk_2["comp_parameters"]["k_dense_info"]["final_k_dens"]

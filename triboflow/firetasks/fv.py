...
class FT_fake_vasp(FiretaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        sample_out_dict = sample_data['miller_list']['111']['74e1730eda410beb1ed6e744a7b1815e5fbf196c']['calcs']['ouc']
        sample_out_dict.update({'task_label': tag})

        nav_low.insert_data(collection='tasks',
                            data=sample_out_dict)

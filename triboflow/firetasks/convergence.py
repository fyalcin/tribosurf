        ...
        if BM_list is None:
            ...
            and is_list_converged(V0_list, V0_tol, n_converge)):
                ...
                if conv_type == 'encut':
                    ...
                    print(' Final encut = {} eV; Final BM = {} GPa;'
                          'Final Volume = {} Angstrom³'
                    ...
                    print(' Final k_dens = {}; Final BM = {} GPa;'
                          'Final Volume = {} Angstrom³'
                          .format(final_k_dens, final_BM, final_V0))
                    print('')
                    print('')
                    output_dict = {'k_dense_info':

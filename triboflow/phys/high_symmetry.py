...
# def get_slab_hs(
#     slab, allowed_sites=["ontop", "bridge", "hollow"], to_array=False
# ):
#     """
...
#     unique_sites = adsf.find_adsorption_sites(
#         distance=0, symm_reduce=0.01, near_reduce=0.01, no_obtuse_hollow=True
#     )

#     # Extract all the HS points for the given surface in the lattice cell
#     replica_sites = adsf.find_adsorption_sites(
#         distance=0, symm_reduce=0, near_reduce=0.01, no_obtuse_hollow=True
#     )
...
#     """
#     top_slab, bot_slab = recenter_aligned_slabs(
#         top_aligned, bot_aligned, d=4.5
#     )
...
#     c_u, c_a = remove_equivalent_shifts(
#         hs_u=hs_unique.copy(),
#         hs_a=hs_all.copy(),
#         top_slab=top_slab,
#         bot_slab=bot_slab,
...
#         unique_struct = stack_aligned_slabs(
#             bot_slab, top_slab, [value[0][0], value[0][1], 0]
#         )
#         unique_struct = clean_up_site_properties(unique_struct)

#         for shift in all_shifts:
#             test_struct = stack_aligned_slabs(
#                 bot_slab, top_slab, top_shift=[shift[0], shift[1], 0]
#             )
...
# def remove_equivalent_shifts(
#     hs_u, hs_a, top_slab, bot_slab, structure_matcher
# ):
...
#         x_shift = value[0][0]
#         y_shift = value[0][1]
#         inter_struct = stack_aligned_slabs(
#             bot_slab, top_slab, top_shift=[x_shift, y_shift, 0]
#         )
...
#             if name != name_2:
#                 if (
#                     structure_matcher.fit(struct, struct_2)
#                     and name not in doubles_found
#                 ):

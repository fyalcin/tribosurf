...
class InitWF:
    ...
    def checkinp_hetero_interface(
        ...
        ft_interface_db = FT_PutInterfaceInDB(
            mat_1="mat_1",
            mat_2="mat_2",
            comp_params="comp",
            inter_params="inter",
    ...
    @staticmethod
    def checkinp_homo_interface(
        material, computational, interface, fw_name="Check input parameters"
    ):
        """
        ...
        # Put the parameters to build the interface in DB
        ft_interface_db = FT_PutInterfaceInDB(
            mat_1="mat", mat_2="mat", comp_params="comp", inter_params="inter"
        )

        fw = Firework(
            [ft_mat, ft_computation, ft_interface, ft_mat_db, ft_interface_db],
            name=fw_name,
        )
    ...
    def checkinp_bulk_convo(
        ...
        # Firetasks checking the material parameters
        ft_mat = FTCheckInput(
            input_dict=material, read_key="bulk_params", output_dict_name="mat"
        )

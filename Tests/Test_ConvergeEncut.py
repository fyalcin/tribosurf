...
out_loc = ['material_1']
EncutConvo_M1 = StartDetourWF_FW('Converge_Encut_SWF',
                            name='Converge Encut '+
                            ...
                            to_pass=['material_1'],
                            encut_start=250)
FWs.append(EncutConvo_M1)

bulk_loc = ['material_2', inputs['material_2']['formula']+'_fromMP']
out_loc = ['material_2']
EncutConvo_M2 = StartDetourWF_FW('Converge_Encut_SWF',
...
Dependencies = {Initialize: [Check_Inputs],
                ...
                Start_M1: [EncutConvo_M1],
                Start_M2: [EncutConvo_M2],
                EncutConvo_M1: [End],
                EncutConvo_M2: [End]}

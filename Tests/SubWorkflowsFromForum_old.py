...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 11:33:47 2020
...
@explicit_serialize
class EndJob(FiretaskBase):

    def run_task(self, fw_spec):
        print('Running the FINAL FW')

if __name__ == '__main__':
    lp = LaunchPad()
# lp.reset('', require_password=False)
# =============================================================================
#     fw1 = Firework([StartJob()])
#     fw2 = Firework([EndJob()], parents=[fw1])
#     wf = Workflow([fw1, fw2])
# =============================================================================
    fw0 = Firework(ScriptTask.from_str('echo start'), name = 'start')
    fw1 = Firework(WorkflowDetourClass())
    fw2 = Firework(EndJob())
    wf = Workflow([fw0, fw1, fw2], {fw0: [fw1], fw1: [fw2]})
